    ...
    <div class="user_center user_content clearfix">
        ...
        <div class="user_main">
            ...
            <div class="item">
                ...
                <input maxlength="100" value="${serviceDetail.serviceName}" id="serviceName" class="ipt_base"
                ...
                <div class="svc_org_item layui-form">
                    <select id="serviceOrg" lay-filter="svcOrg">
                        ...
                        <c:forEach items="${orgNames}" var="item">
                            <option value="${item.orgoid}" ${item.orgoid == serviceDetail.orgOid ? 'selected':''}>${item.orgname}</option>
                        </c:forEach>
                    </select>
                </div>
            ...
            <div class="item">
                ...
                <div class="svc_price clearfix">
                    <div id="pricePanel" class="price_panel clearfix">
                        <p>
                            <label class="${serviceDetail.servicePrice.flag == 3?'cur_checked':''}">
                                <input data-origin="all" type="radio" name="price" onclick="switchRadio(this)"
                                       onchange="clearPriceTip()" ${serviceDetail.servicePrice.flag == 3?"checked":""}>
                            </label>
                            <span>面议</span>
                        </p>
                        <p>
                            <label class="${serviceDetail.servicePrice.flag == 1?'cur_checked':''}">
                                <input data-origin="fixed" type="radio"
                                       name="price" ${serviceDetail.servicePrice.flag == 1?"checked":""}
                                       onclick="switchRadio(this)" onchange="clearPriceTip()">
                            </label>
                            <span>具体价格</span>
                        </p>
                        <p>
                            <label class="${serviceDetail.servicePrice.flag == 2?'cur_checked':''}">
                                <input data-origin="range" type="radio" name="price" onclick="switchRadio(this)"
                                ${serviceDetail.servicePrice.flag == 2?"checked":""}
                    ...
                    <div id="fixedPrice" class="price_ipt clearfix"
                         style="display: ${serviceDetail.servicePrice.flag == 1?'block':'none'}">
                        <p>
                            <input id="fixedPriceP" type="text"
                                   value="${serviceDetail.servicePrice.flag == 1 ? serviceDetail.servicePrice.accPrice:''}"
                                   placeholder="具体价格" onfocus="clearPriceTip()">
                        </p>
                        <p class="span">元/</p>
                        <p>
                            <input id="fixedUnit"
                                   value="${serviceDetail.servicePrice.flag == 1 ? serviceDetail.servicePrice.unit:''}"
                                   type="text" maxlength="10" placeholder="单位" onfocus="clearPriceTip()">
                        </p>
                    </div>
                    <div id="rangPrice"
                         class="price_ipt clearfix"
                         style="display: ${serviceDetail.servicePrice.flag == 2?'block':'none'}">
                        <p>
                            <input id="rangeSubPrice"
                                   value="${serviceDetail.servicePrice.flag == 2 ? serviceDetail.servicePrice.scopeLowPrice:''}"
                                   type="text" placeholder="最低价" onfocus="clearPriceTip()">
                            <%--<span><i class="lab-gantanhao"></i>最高价需大于最低价</span>--%>
                        </p>
                        <p class="span">元&nbsp;~</p>
                        <p>
                            <input id="rangeSupPrice"
                                   value="${serviceDetail.servicePrice.flag == 2 && serviceDetail.servicePrice.scopeHighPrice != 0? serviceDetail.servicePrice.scopeHighPrice:''}"
                                   type="text" placeholder="最高价" onfocus="clearPriceTip()">
                            <%--<span><i class="lab-gantanhao"></i>最高价需大于最低价</span>--%>
                        </p>
                        <p class="span">元/</p>
                        <p for="">
                            <input id="rangeUnit"
                                   value="${serviceDetail.servicePrice.flag == 2 ? serviceDetail.servicePrice.unit:''}"
                                   type="text"   maxlength="10"  placeholder="单位">
            ...
            <div class="item">
                ...
                <div class="svc_textarea">
                    <textarea id="priceInfos" cols="45" rows="4"
                              maxlength="200">${serviceDetail.servicePrice.remark}</textarea>
                </div>
            </div>
            <%--机构信息--%>
            <div class="secent_tit">
            ...
            <div class="item">
                <span>服务简介：</span>
                <div class="svc_textarea">
                    <textarea id="serviceInfo" cols="45" rows="4"
                              maxlength="5000">${serviceDetail.serviceDes}</textarea>
                </div>
            </div>
            <%--使用设备--%>
            <div class="item">
                ...
                <div class="svc_ins clearfix">
                    <div id="insList" class="svc_ins_list clearfix">
                        <c:forEach items="${serviceDetail.serviceMachine}" var="item">
                            ...
                            <p>
                                <input maxlength="100" value="${item}" class="ipt_base" type="text" placeholder="请输入使用设备">
            ...
            <div class="item">
                <span>依据方法：</span>
                <input value="${serviceDetail.serviceMethod}"
                        id="serviceMethos" maxlength="200" class="ipt_base" type="text" placeholder="方法、标准、技术规范"
                       style="float: left">
            ...
            <div class="item">
                <span>服务周期：</span>
                <input id="serviceCycle" value="${serviceDetail.servicePeriod}" maxlength="200" class="ipt_base" type="text" placeholder="请输入服务周期"
                       style="float: left">
                <s class="error_tip rt_tip" style="display:none;line-height: 38px;margin-left: 10px;float: left">请输入正确的服务名称</s>
            </div>
            <%--其他备注--%>
            <div class="item">
                <span>其他备注：</span>
                <div class="svc_textarea">
                    <textarea id="otherInfo" cols="45" rows="4" maxlength="1000">${serviceDetail.serviceNote}</textarea>
                </div>
            </div>
            <%--联系方式--%>
            <div class="item">
                ...
                <div class="ct_box">
                    ...
                    <table class="linkman" style="display: block;">
                        <thead>
                        <tr>
                            <th>联系人姓名</th>
                            <th>联系电话</th>
                        ...
                        <tbody id="phoneList">
                            ...
                            <c:forEach var="item" items="${serviceDetail.serviceContacts}">
                                <tr class="">
                                    <td class="name">
                                        <input onfocus="clearPeopleTip(this)" type="text" value="${item.conName}" placeholder="请输入联系人姓名">
                                    </td>
                                    <td class="phone">
                                        <input onfocus="clearPeopleTip(this)" type="text" value="${item.conPhone}" placeholder="请输入联系人电话">
                                    </td>
                                    <td style="background-color: #fff;">
                                        <s class="error_tip rt_tip" style="display:block;line-height: 38px;float: left;display: none">
                                            <i class="lab-gantanhao" style="padding-left:10px;margin-right: 5px;vertical-align: middle;">
                                            </i>联系人或联系方式格式错误
                                        </s>
                                    </td>
                                </tr>
            ...
            <div class="item">
                ...
                <input id="addressDetail_1" value="${serviceDetail.serviceAddress}" onblur="updateJingWeiDu()" maxlength="50" class="ipt_base" type="text"
            ...
            <%--提交申请--%>
            <div class="cfm">
                <button type="button" onclick="putOrgForm()">修改服务</button>
            </div>
        </div>
...
//            }
            ...
            if ($.trim(scopeHighPrice) == "") {
                ...
                scopeLowPrice = scopeLowPrice - 0;
                scopeHighPrice = scopeHighPrice - 0;
...
//            serviceMachine: serviceMachine,// 使用设备
    ...
    function putService(formData) {
        ...
        $.ajax({
            url: BASE_URL + '/user/service_modify',
            type: 'POST',
            dataType: "json",
            contentType: "application/json",
            ...
            success: function (data) {
                if (data.code === 0) {
                    location.href = BASE_URL + "/user/service_detail_page?serviceId=" + '${serviceDetail.serviceId}';
    ...
    function initAddress() {
        ...
        $("#province_1").find("option").each(function () {
            ...
            if ($.trim($(this).val()) === '${serviceDetail.serviceProvince}') {
                ...
                dealProvinceId($(this).data("provinceId"), function (cityList) {
                    ...
                    $("#city_1").find("option").each(function (index) {
                        ...
                        if ($.trim($(this).val()) === '${serviceDetail.serviceCity}') {
                            $(this).attr("selected", true);
                            form.render();
                            getCity($(this).data("cityId"), function (cityList) {
                                ...
                                $("#county_1").find("option").each(function () {
                                    if ($.trim($(this).val()) === '${serviceDetail.serviceDistrict}') {
                                        $(this).attr("selected", true);
                                        form.render();
                                        var flag = searchByStationName(map, "${serviceDetail.serviceProvince}${serviceDetail.serviceCity}${serviceDetail.serviceDistrict}${serviceDetail.serviceAddress}");
                                        if (!flag) {
                                            searchByStationName(map, "${serviceDetail.serviceProvince}${serviceDetail.serviceCity}");
                                        }
                                        return false;
                                    }
                                })
