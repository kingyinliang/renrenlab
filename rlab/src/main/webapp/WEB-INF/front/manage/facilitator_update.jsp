    ...
    <div class="user_center user_content clearfix">
        ...
        <div class="user_main">
            ...
            <div class="item">
                ...
                <input id="uName" maxlength="10" value="${orgInfo.orgLicense.orgPerson}" class="ipt_base" type="text"
                       placeholder="请输入真实姓名" data-add-place="no" style="float: left">
            ...
            <div class="item">
                ...
                <input id="uIdCard" value="${orgInfo.orgLicense.identificationNumber}" class="ipt_base" type="text"
                       placeholder="请输入真实身份证号" maxlength="18" data-add-place="no" style="float: left">
                ...
                <div class="identity_box">
                    <div class="img_item">
                        <label class="ipt_lable">
                            <span></span>
                            <c:if test="${orgInfo.orgLicense.legalPersonPic1 != null}">
                                <img id="idCardFront" src="${orgInfo.orgLicense.legalPersonPic1}" alt="">
                                <form method="post" enctype="multipart/form-data">
                                    <input id="idCardFrontInput" data-load-type="2"
                    ...
                    <div class="img_item">
                        <label class="ipt_lable">
                            <span></span>
                            <c:if test="${orgInfo.orgLicense.legalPersonPic2 != null}">
                                <img id="idCardVerso" src="${orgInfo.orgLicense.legalPersonPic2}" alt="">
                                <form method="post" enctype="multipart/form-data">
                                    <input id="idCardVersoInput" data-load-type="2"
                                           data-spin="${rlab}/front/imgs/icon/2_2/add_type3_loading.gif"
                            ...
                            <c:if test="${orgInfo.orgLicense.legalPersonPic2 == null}">
                                <img src="${rlab}/front/imgs/icon/2_2/add_type3.png" alt=""
                ...
                <div class="logo_box">
                    <label class="ipt_lable" style="float: left">
                        ...
                        <c:if test="${orgInfo.orgLogo != null}">
                            <img id="logoImg" src="${orgInfo.orgLogo}" alt="">
                            <form method="post" enctype="multipart/form-data">
                                <input id="logoInput" data-load-type="2"
                                       data-spin="${rlab}/front/imgs/icon/2_2/add_type1_loading.gif"
                                       type="file" name="file" onchange="uploadLogos(this)"
                                       onclick="clearLogoTip(this)">
                            </form>
                        </c:if>
                        <c:if test="${orgInfo.orgLogo == null}">
                    ...
                    <s id="logoErrorTip" class="error_tip rt_tip" style="display:none;right:-232px;height: 38px;line-height: 38px;margin-left: 10px;">请上传机构logo</s>
                </div>
            </div>
            <%--机构材料--%>
            <div class="item">
                ...
                <div class="org_license">
                    <div class="radio_swift">
                        <c:choose>
                            <c:when test="${orgInfo.orgCodeObject.orgCodePic == null || orgInfo.orgLicense.taxEnrolCertificatePic == null || ''.equals(orgInfo.orgCodeObject.orgCodePic) || ''.equals(orgInfo.orgLicense.taxEnrolCertificatePic)}">
                                <label class="ckbox checkbox_checked">
                                    <input id="szhy" type="checkbox" checked onclick="changeCheck(this)"
                                           onchange="slideUp(this)">
                                </label>
                            </c:when>
                            <c:otherwise>
                                <label class="ckbox checkbox_cancel">
                                    <input id="szhy" type="checkbox" onclick="changeCheck(this)"
                                           onchange="slideUp(this)">
                                </label>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <div>
                        <div id="orgPapers1" class="img_item">
                            <label class="ipt_lable">
                                <span></span>
                                <c:choose>
                                    <c:when test="${orgInfo.orgLicense.orgLicensePic != null}">
                                        <img id="orgCard1Img" src="${orgInfo.orgLicense.orgLicensePic}" alt="">
                                        <form method="post" enctype="multipart/form-data">
                                            <input id="orgCard1Input" data-load-type="2"
                                                   data-spin="${rlab}/front/imgs/icon/2_2/add_type3_loading.gif"
                                                   type="file" name="file" onchange="uploadLogos(this)"
                        ...
                        <div id="orgPapers2" class="img_item"
                             style="display: ${orgInfo.orgCodeObject.orgCodePic != null && !''.equals(orgInfo.orgCodeObject.orgCodePic)?'block':'none'}">
                            <label class="ipt_lable">
                                <span></span>
                                <c:choose>
                                    <%--${orgInfo.orgCodeObject.orgCodePic == null || orgInfo.orgLicense.taxEnrolCertificatePic == null}--%>

                                    <c:when test="${orgInfo.orgCodeObject.orgCodePic != null && !''.equals(orgInfo.orgCodeObject.orgCodePic)}">
                                        <img id="orgCard2Img" src="${orgInfo.orgCodeObject.orgCodePic}" alt="">
                                        <form method="post" enctype="multipart/form-data">
                                            <input id="orgCard2Input" data-load-type="2"
                                                   data-spin="${rlab}/front/imgs/icon/2_2/add_type3_loading.gif"
                                                   type="file" name="file" onchange="uploadLogos(this)"
                                                   onclick="clearErrorPaper(this)"
                                            >
                        ...
                        <div id="orgPapers3" class="img_item"
                             style="display: ${orgInfo.orgLicense.taxEnrolCertificatePic != null && !''.equals(orgInfo.orgLicense.taxEnrolCertificatePic)?'block':'none'}">
                            <label class="ipt_lable">
                                <span></span>
                                <c:choose>
                                    <c:when test="${orgInfo.orgLicense.taxEnrolCertificatePic != null && !''.equals(orgInfo.orgLicense.taxEnrolCertificatePic)}">
                                        <img id="orgCard3Img" src="${orgInfo.orgLicense.taxEnrolCertificatePic}" alt="">
                                        <form method="post" enctype="multipart/form-data">
                                            <input id="orgCard3Input" data-load-type="2"
                                                   data-spin="${rlab}/front/imgs/icon/2_2/add_type3_loading.gif"
                                                   type="file" name="file" onchange="uploadLogos(this)"
                                                   onclick="clearErrorPaper(this)">
                                        </form>
            ...
            <div class="item">
                ...
                <input id="orgName" value="${orgInfo.orgName}" class="ipt_base" type="text" placeholder="请输入机构名称"
                       style="float: left;" maxlength="100" data-add-place="no">
            ...
            <div class="item">
                ...
                <input id="orgCode" value="${orgInfo.orgCode}" class="ipt_base" type="text" placeholder="请输入组织机构代码"
                       style="float: left;" data-add-place="no">
            ...
            <div class="item">
                ...
                <div class="layui-form" style="width: 198px;float: left;">
                    <select id="orgNature" name="city" lay-verify="" lay-filter="orgNature">
                        <option ${orgInfo.orgCategoryId == null || "".equals(orgInfo.orgCategoryId)?'selected':''} value="">请选择...</option>
                        <option ${orgInfo.orgCategoryId  != null && orgInfo.orgCategoryId == 1?'selected':''} value="1">科研院所</option>
                        <option ${orgInfo.orgCategoryId  != null && orgInfo.orgCategoryId == 2?'selected':''} value="2">高等院校</option>
                        <option ${orgInfo.orgCategoryId  != null && orgInfo.orgCategoryId == 3?'selected':''} value="3">国有企业</option>
                        <option ${orgInfo.orgCategoryId  != null && orgInfo.orgCategoryId == 4?'selected':''} value="4">民营企业</option>
                        <option ${orgInfo.orgCategoryId  != null && orgInfo.orgCategoryId == 15?'selected':''} value="5">第三方检测</option>
                        <option ${orgInfo.orgCategoryId  != null && orgInfo.orgCategoryId == 99?'selected':''} value="99">其他</option>
                    </select>
                </div>
                <s id="orgNatureTip" class="error_tip rt_tip" style="display:none;right:-232px;height: 38px;line-height: 38px;margin-left: 10px;">请选择机构性质</s>
            </div>
            <%--机构注册地--%>
            <div class="item">
                ...
                <div class="layui-form" style="float: left;">
                    ...
                    <div class="ad_new_item" style="">
                        <select id="province_1" name="quiz1" lay-filter="province1" style="width: 114px;">
                            ...
                            <%--${orgInfo.orgLicense.orgAddrProvince}--%>
                        </select>
                    </div>
                    <%--市--%>
                    <div class="ad_new_item">
                        <select id="city_1" name="quiz2" lay-filter="city1">
                            <option value="">请选择市</option>
                            <%--${orgInfo.orgLicense.orgAddrCity}--%>
                        </select>
                    </div>
                    <%--区--%>
                    <div class="ad_new_item">
                        <select id="county_1" name="quiz3" lay-filter="county1">
                            ...
                            <%--${orgInfo.orgLicense.orgAddrDistrict}--%>
                        </select>
                    </div>
                </div>
            ...
            <div class="item">
                ...
                <input id="orgDetail_1" value="${orgInfo.orgLicense.orgAddress}" class="ipt_base" type="text"
                       placeholder="请输入详细地址" style="float: left;" maxlength="100" data-add-place="no">
                ...
                <div class="layui-form" style="float: left;">
                    ...
                    <div class="ad_new_item" style="">
                        <select id="province_2" name="quiz1" lay-filter="province2" style="width: 114px;">
                            ...
                            <option value="宁夏回族自治区" data-province-id="640000">宁夏回族自治区</option>
                            <option value="新疆维吾尔自治区" data-province-id="650000">新疆维吾尔自治区</option>
                            <%--${orgInfo.orgAddress.orgAddrProvince}--%>
                        </select>
                    </div>
                    <%--市--%>
                    <div class="ad_new_item">
                        <select id="city_2" name="quiz2" lay-filter="city2">
                            <option value="">请选择市</option>
                            <%--${orgInfo.orgAddress.orgAddrCity}--%>
                        </select>
                    </div>
                    <%--区--%>
                    <div class="ad_new_item">
                        <select id="county_2" name="quiz3" lay-filter="county2">
                            <option value="">请选择县/区</option>
                            <%--${orgInfo.orgAddress.orgAddrDistrict}--%>
                        </select>
                    </div>
            ...
            <div class="item">
                <span>详细地址<em>*</em>：</span>
                <input id="addressDetail_2" value="${orgInfo.orgAddress.orgAddrStreet}" onblur="updateJingWeiDu()"
                       class="ipt_base" type="text" maxlength="100" placeholder="请输入详细地址" style="float: left;"
                       data-add-place="no">
            ...
            <div class="item">
                ...
                <input onfocus="clearLatTip()" id="longitude2" value="${orgInfo.orgAddress.orgAddrLongitude}"
                       class="ipt_base" type="text"
                       placeholder="东经" style="width: 100px;float: left;margin-right: 15px" data-add-place="no">
                <input onfocus="clearLatTip()" id="latitude2" class="ipt_base"
                       value="${orgInfo.orgAddress.orgAddrLatitude}" type="text"
                       placeholder="北纬" style="width: 100px;float: left;;" data-add-place="no">
            ...
            <div class="item">
                ...
                <div id="addCall" class="org_call">
                    <c:forEach items="${orgInfo.orgContacts.conPhoneList}" var="item" varStatus="status">
                        <input onclick="clearFixedPhoneTip()" class="ipt_base" value="${item}" type="text"
                               placeholder="请输入机构座机" data-add-place="no">
                    </c:forEach>
            ...
            <div class="item">
                <span>机构邮编：</span>
                <input id="orgPostcode" value="${orgInfo.orgAddress.orgZipcode}" class="ipt_base" type="text"
                       placeholder="请输入机构邮编" data-add-place="no">
            ...
            <div class="item">
                <span>机构网址：</span>
                <input id="orgWeb" value="${orgInfo.orgWeb}" class="ipt_base" type="text" placeholder="请输入机构网址"
                       data-add-place="no">
            ...
            <div class="item">
                <span>机构传真：</span>
                <input id="orgFax" value="${orgInfo.orgContacts.conFax}" class="ipt_base" type="text"
                       placeholder="请输入机构传真" data-add-place="no">
            ...
            <div class="item">
                <span>机构邮箱：</span>
                <input id="orgEmail" maxlength="50" value="${orgInfo.orgContacts.conEmail}" class="ipt_base" type="text"
                       placeholder="请输入机构邮箱" data-add-place="no">
            ...
            <div class="item">
                ...
                <div class="org_person" id="orgPeople">
                    <c:forEach items="${orgInfo.orgContactsList}" var="item" varStatus="status">
                        <div class="person_item">
                            <div class="person_name">
                                <input class="ipt_base" value="${item.conName}" type="text" style="float: left;"
                                       placeholder="联系人姓名" data-add-place="no">
                            ...
                            <span class="icon_box" style="float: left;">
                                <c:if test="${status.first}">
                                 ...
                                 <c:if test="${!status.first}">
                                   <i class="down_icon lab-del_type1" onclick="delPersonRow(this)"
                                      style="width: 45px;"></i>
                                 </c:if>
                             </span>
                            <div class="person_phone">
                                <c:forEach items="${item.conPhoneList}" var="small_item" varStatus="status">
                                    <div>
                                        <input class=" ipt_base" value="${small_item}" type="text" placeholder="联系人号码"
                                               style="float: left;" data-add-place="no">
                    ...
                    <%--</div>--%>
                    <%--<span class="icon_box" style="float: left;">--%>
                    <%--<i class="up_icon lab-addicon" onclick="addPersonRow()"></i>--%>
                    <%--&lt;%&ndash;<i class="down_icon lab-addicon"></i>&ndash;%&gt;--%>
                    <%--</span>--%>
                    <%--&lt;%&ndash;联系人电话号码&ndash;%&gt;--%>
                    <%--<div class="person_phone">--%>
                    <%--<div>--%>
                    <%--<input class=" ipt_base" type="text" placeholder="联系人号码" style="float: left;">--%>
                    <%--<s class="error_tip phone_error_tip" style="display:none;right:-232px;">请输入正确的手机号码</s>--%>
                    <%--</div>--%>
                    <%--<span class="icon_box" style="position: absolute;right: -68px;top: 0">--%>
                    <%--<i class="up_icon lab-addicon" onclick="addPersonPhone(this)"></i>--%>
                    <%--<i class="down_icon lab-addicon" onclick="delPersonPhone(this)"></i>--%>
                    <%--</span>--%>
                    <%--</div>--%>
                    <%--</div>--%>
                </div>
            ...
            <div class="item">
                ...
                <div class="layui-form" style="width: 198px;float: left;">
                    <select id="orgOrigin" name="city" lay-verify="" lay-filter="orgOrigin">
                        <option ${orgInfo.orgSource == null || "".equals(orgInfo.orgSource)?"selected":""} value="">
                            请选择机构来源
                        </option>
                        <option ${orgInfo.orgSource  != null && orgInfo.orgSource == 0?"selected":""} value="0">线下活动
                        </option>
                        <option ${orgInfo.orgSource  != null && orgInfo.orgSource == 1?"selected":""} value="1">运营拓展
                        </option>
                        <option ${orgInfo.orgSource  != null && orgInfo.orgSource == 2?"selected":""} value="2">线上平台
                        </option>
                    </select>
                </div>
            ...
            <div class="item">
                ...
                <div class="org_zz">
                    ...
                    <div id="identifyList" class="zz_box">
                        <c:forEach items="${orgInfo.orgCertificateList}" var="item" varStatus="status">
                            <div class="img_item">
                                <label class="ipt_lable">
                                    <span></span>
                                    <c:choose>
                                        <c:when test="${item.orgCertificatePic != null && !''.equals(item.orgCertificatePic)}">
                                            <img src="${item.orgCertificatePic}" alt="">
                                            <form method="post" enctype="multipart/form-data">
                                                <input data-load-type="2" data-zz-id="${item.orgCertificateId}"
                                                       data-spin="http://localhost:8080/front/imgs/icon/2_2/add_type2_loading.gif"
                                                       type="file" name="file" onchange="uploadLogos(this)"
                                                       onclick="clearErrorZZ(this)">
                                            </form>
                                        </c:when>
                                        <c:otherwise>
                                            <img src="${rlab}/front/imgs/icon/2_2/add_type2.png" alt="">
                                            <form method="post" enctype="multipart/form-data">
                                                <input data-load-type="0" data-zz-id="${item.orgCertificateId}"
                                                       data-spin="http://localhost:8080/front/imgs/icon/2_2/add_type2_loading.gif"
                                                       type="file" name="file" onchange="uploadLogos(this)"
                                                       onclick="clearErrorZZ(this)">
                                            </form>
            ...
            <div class="item" onclick="clearIntroTip()">
                ...
                <div class="org_intro">
                    <textarea class="layui-textarea" id="LAY_demo1"
                              style="display: none">${orgInfo.orgDescription}</textarea>
...
<script type="text/javascript">
     ...
     * 填充城市（市级别 注册地）
     */
    function fillCity1(cityList, cb) {
...
//            fixedPhone: /([0-9]{3,4}-)?[0-9]{7,8}/
        ...
        orgPeopleList.each(function () {
            ...
            if (!/^[\u4e00-\u9fa5]{2,10}$/.test(orgPeopleName.val())) {
...
//                        }, 1000);
    ...
    /* ------------------------------  第四段代码区域块(START)  ---------------------------------- */
    // 初始化
    var initProvince1 = '${orgInfo.orgLicense.orgAddrProvince}';
    var initCity1 = '${orgInfo.orgLicense.orgAddrCity}';
    var initCounty1 = '${orgInfo.orgLicense.orgAddrDistrict}';
    var initOrgDetail1 = '${orgInfo.orgLicense.orgAddress}';


    var initProvince2 = '${orgInfo.orgAddress.orgAddrProvince}';
    var initCity2 = '${orgInfo.orgAddress.orgAddrCity}';
    var initCounty2 = '${orgInfo.orgAddress.orgAddrDistrict}';
    var initOrgDetail2 = '${orgInfo.orgAddress.orgAddrStreet}';

    /*
     ** 初始化地址
     */
    function initAddress(form) {
        $("#province_1").find("option").each(function () {
            if ($.trim($(this).val()) === initProvince1) {
                ...
                dealProvinceId($(this).data("provinceId"), function (cityList) {
                    ...
                    fillCity1(cityList);
                    // 勾选selected
                    $("#city_1 option").each(function () {
                        if ($.trim($(this).val()) === initCity1) {
                            $(this).attr("selected", true);// 设置市选中
                            getCity($(this).data("cityId"), function (cityList) {
                                // 填充county1
                                fillCounty1(cityList);
                                // 选中county1
                                $("#county_1").find("option").each(function () {
                                    if ($.trim($(this).val()) === initCounty1) {
                                        $(this).attr("selected", true);// 设置市选中
...
//                })
        ...
        $("#province_2").find("option").each(function () {
            if ($.trim($(this).val()) === initProvince2) {
                $(this).attr("selected", true);
                // 更新市列表
                dealProvinceId($(this).data("provinceId"), function (cityList) {
                    // 填充city
                    fillCity2(cityList);
                    // 勾选selected
                    $("#city_2 option").each(function () {
                        if ($.trim($(this).val()) === initCity2) {
                            $(this).attr("selected", true);// 设置市选中
                            getCity($(this).data("cityId"), function (cityList) {
                                // 填充county1
                                fillCounty2(cityList);
                                // 选中county1
                                $("#county_2").find("option").each(function () {
                                    if ($.trim($(this).val()) === initCounty2) {
                                        $(this).attr("selected", true);// 设置市选中
                                        form.render("select");// 更新
                                    }
                                })
