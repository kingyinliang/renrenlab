    ...
    <div class="scientificSearch" >
		<div id="message" >
			...
			<div id="correlationMessage">
				<ul>
					<c:forEach items="${result.re}" var="relatedInfo" begin="0" end="9"  varStatus="st">
						<li>
				...
				<div id="pages" style="text-align: center;overflow: hidden;">
						<a id="next" href="JavaScript:location.href='${rlab}/front/kejso/moreRelatedInfo?pageNo=${pageNo +1}&pageSize=10&query='+encodeURI('${keyword}');">下一页</a>
					<c:if test="${pageNo != 0}">
						<a id="top" href="JavaScript:location.href='${rlab}/front/kejso/moreRelatedInfo?pageNo=${pageNo -1}&pageSize=10&query='+encodeURI('${keyword}');">上一页</a>
					</c:if>
				</div>
			</div>
		</div>
