    ...
    <div id="content">
        <div class="main clearfix">
            ...
            <div class="content" style="margin-bottom: 30px">
                ...
                <div class="intro">
                    <div class="page1">
                        <p class="sm" style="margin-bottom: 26px">人人实验（北京）科技有限公司（以下简称“人人实验”）依据《人人实验平台服务使用协议》（以下简称“本协议”）的规定提供服务，本协议具有合同效力。用户注册时，请您认真阅读本协议，审阅并接受或不接受本协议（未成年人应在法定监护人陪同下审阅）。</p>
                        <p class="sm" style="margin-bottom: 38px">若您已经注册为人人实验平台用户，即表示您已充分阅读、理解并同意自己与人人实验订立本协议，且您自愿受本协议的条款约束。人人实验有权随时变更本协议并在人人实验官网上予以公告。经修订的条款一经在人人实验官网公布后，立即自动生效。如您不同意相关变更，必须停止使用人人实验。本协议内容包括协议正文及所有人人实验已经发布的各类协议。所有协议为本协议不可分割的一部分，与本协议正文具有同等法律效力。一旦您继续使用人人实验平台，则表示您已接受并自愿遵守经修订后的条款。</p>
                        <p class="sm" style="margin-bottom: 18px">名词解释：</p>
                        <p class="big clearfix"><span style="color: #999999">人人实验：</span><span>指人人实验（北京）科技有限责任公司，以下简称“人人实验”；</span></p>
                        <p class="big clearfix"><span class="blo" style="color: #999999;font-weight: normal">服务商：</span><span class="bloh">指与人人实验平台达成合作的机构和个人；或者经授权获得服务商单位营业执照或组织机构代码，并经该服务商管理员审核，拥有管理和操作该服务商已上线资源的机构和个人；</span></p>
                        <p class="big clearfix" style="margin-bottom: 43px"><span style="color: #999999">用户：</span><span>指具有完全民事行为能力的、使用人人实验平台各项服务的自然人或者法人；</span></p>
                        ...
                        <p class="sm" style="color: #666666;margin-bottom: 20px">
                            ...
                            3、人人实验平台用户须承诺遵守法律法规、社会主义制度、国家利益、公民合法权益、公共秩序、社会道德风尚和保证信息真实性。
                        </p>
                        <p class="big clearfix"><span class="blo">第十条</span><span class="bloh">用户的权利和义务</span></p>
                        <p class="sm" style="color: #666666">
                    ...
                    <div class="page2" style="display: none">
                        ...
                        <p class="sm" style="margin-bottom: 30px;color: #666666">
                            ...
                            C、存在用户或其他第三方通知人人实验，认为某个用户或具体交易事项存在违法或不当行为，并提供相关证据，而人人实验无法联系到该用户核证或验证该用户向人人实验提供的任何资料。</br>
                            D、存在用户或其他第三方通知人人实验，认为某个用户或具体交易事项存在违法或不当行为，并提供相关证据。人人实验以普通非专业人员的知识水平标准对相关内容进行判别，可以明显认为这些内容或行为可能对他方或人人实验造成损失或承担法律责任。</br>
                        ...
                        <p class="sm" style="margin-bottom: 30px;color: #666666">
                            ...
                            A、人人实验平台将符合所有用户的要求。</br>
                            B、人人实验平台不受干扰、能够及时提供、安全可靠或免于出错。</br>
                            ...
                            3、用户经由人人实验平台取得的建议和资讯，无论其形式或表现，绝不构成本协议未明示规定的任何保证。</br>　
                            4、基于以下原因而造成的利润、商誉、使用、资料损失或其它无形损失，人人实验不承担任何直接、间接、附带、特别、衍生性或惩罚性赔偿（即使人人实验已被告知前款赔偿的可能性）：</br>
                            A、人人实验平台的使用或无法使用。</br>
                        ...
                        <p class="sm" style="margin-bottom: 30px;color: #666666">
                            1、信息使用：</br>
                            A、人人实验不会向任何人出售或出借用户的个人或法人信息，除非事先得到用户得许可。</br>
                            B、人人实验亦不允许任何第三方以任何手段收集、编辑、出售或者无偿传播用户的个人或法人信息。任何用户如从事上述活动，一经发现，人人实验有权立即终止与该用户的服务协议，查封其账号。</br>
                    ...
                    <div class="page3" style="display: none">
                        <p class="sm" style="margin-bottom: 30px;color: #666666">
                            A、经用户同意，向第三方披露。</br>
                            B、用户在使用人人实验平台过程中涉及到知识产权类纠纷，有他方主张权利的，人人实验在审核主张方提交的资料后认为披露用户信息有助于纠纷解决的。</br>
                            C、根据法律的有关规定，或者行政、司法机关的要求，向第三方或者行政、司法机关披露。</br>
                            D、若用户出现违反中国有关法律或者网站规定的情况，需要向第三方披露。</br>
                            E、为提供您所要求的产品和服务，而必须和第三方分享用户的个人或法人信息。</br>
                            F、其它根据法律或者网站规定，人人实验认为合适的披露。</br>
                            3、信息安全：</br>
                            A、在使用人人实验服务平台进行网上交易时，请用户妥善保护自己的个人或法人信息，仅在必要的情形下向他人提供。</br>
                            B、如果用户发现自己的个人或法人信息泄密，尤其是用户账户或“支付账户管理”账户及密码发生泄露，请用户立即联络人人实验平台客服，以便我们采取相应措施。
                        </p>
