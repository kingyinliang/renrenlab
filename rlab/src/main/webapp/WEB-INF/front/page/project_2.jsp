            ...
            <div class="list">
                ...
                <div id="pages" style="text-align: center;overflow: hidden;">
                    ...
                    <%--<c:if test="${relatedProject!=null}">--%>
                        <a id="next" href="JavaScript:location.href='${rlab}/front/superSearch/morePro?pageNo=${pageNo +1}&pageSize=10&query='+encodeURI('${keyword}');">下一页</a>
                    </c:if>
                    <c:if test="${pageNo != 0}">
                        <a id="top" href="JavaScript:location.href='${rlab}/front/superSearch/morePro?pageNo=${pageNo -1}&pageSize=10&query='+encodeURI('${keyword}');">上一页</a>
                    </c:if>
                </div>
            </div>
        </div>
