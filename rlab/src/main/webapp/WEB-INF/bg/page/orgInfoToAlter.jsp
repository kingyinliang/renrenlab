...
<div class="wrapper">
    ...
    <div class="comn">
        ...
        <div class="main" style="overflow-y: auto">
            ...
            <div class="share_main clearfix">
                <form class="layui-form" action="">
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input maxlength="100" id="orgName" class="lab_input_base " value="${orgInfo.orgName}"
                                   type="text" placeholder="请输入机构名称" style="width: 754px;" maxlength="100">
                        </div>
                    </div>
                    <div class="lab_p parent_org clearfix">
                        ...
                        <div class="rt">
                            <%--<input class="lab_input_base " value="${orgInfo.parentOrgName}" type="text"--%>
                            <%--placeholder="请输入隶属机构名称" style="width: 600px;">--%>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <%--START三级联动--%>
                            <%--<div id="addCon" class="layui-form-item city_select">--%>
                            <div id="addCon" data-org-addr-id="${orgInfo.orgAddress.orgAddrId}"
                                 class="layui-form-item city_select">
                                <div class="layui-input-inline">
                                ...
                                <div class="layui-input-inline">
                                    <select id="city" name="quiz2" lay-filter="city">
                                        ...
                                        <%--<c:if test="${orgInfo.orgAddress.orgAddrCity != null || !''.equals(orgInfo.orgAddress.orgAddrCity) || !'暂无'.equals(orgInfo.orgAddress.orgAddrCity)}">--%>
                                        <%--<option value="${orgInfo.orgAddress.orgAddrCity}"--%>
                                        <%--selected>${orgInfo.orgAddress.orgAddrCity}</option>--%>
                                        <%--</c:if>--%>
                                    </select>
                                </div>
                                ...
                                <div class="layui-input-inline">
                                    <select id="county" name="quiz3" lay-filter="county">
                                        ...
                                        <%--<c:if test="${orgInfo.orgAddress.orgAddrDistrict != null || !''.equals(orgInfo.orgAddress.orgAddrDistrict) || !'暂无'.equals(orgInfo.orgAddress.orgAddrDistrict)}">--%>
                                        <%--<option value="${orgInfo.orgAddress.orgAddrDistrict}"--%>
                                        <%--selected>${orgInfo.orgAddress.orgAddrDistrict}</option>--%>
                                        <%--</c:if>--%>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div>
                                <input maxlength="100" value="${orgInfo.orgAddress.orgAddrStreet}" id="addressDetail"
                                       class="lab_input_base lab_input_middle" type="text"
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            ...
                            <input id="longitude" value="${orgInfo.orgAddress.orgAddrLongitude}" type="text"
                                   class="lab_input_base" placeholder="请输入" style="width: 110px;margin-right: 20px;">
                            <span style="margin-right: 5px">北纬</span>
                            <input id="latitude" value="${orgInfo.orgAddress.orgAddrLatitude}" class="lab_input_base"
                                   type="text" placeholder="请输入" style="width: 110px;">
                        </div>
                    </div>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="orgZipcode" value="${orgInfo.orgAddress.orgZipcode}"
                                   class="lab_input_base lab_input_middle" type="text" placeholder="邮编...">
                        </div>
                    </div>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="orgWeb" value="${orgInfo.orgWeb}" class="lab_input_base lab_input_middle"
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input maxlength="20" id="conFax" value="${orgInfo.orgContacts.conFax}"
                                   class="lab_input_base lab_input_middle" type="text" placeholder="传真...">
                        </div>
                    </div>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="conEmail" value="${orgInfo.orgContacts.conEmail}"
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="orgCode" value="${orgInfo.orgCode}" class="lab_input_base lab_input_middle"
                                   type="text"
                                   placeholder="请输入...">
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            ...
                            <div id="qftList" class="org_qua">
                                ...
                                <%--<p>资质1</p>--%>
                                <%--<div class="qualification">--%>
                                <%--<img src="${rlab}/bg/img/add_status_default.png">--%>
                                <%--<input onchange="uploadImg(this)" name="qualifications" accept="image/jpg,image/jpeg,image/png,image/bmp" type="file">--%>
                                <%--</div>--%>
                                <%--</div>--%>
                            </div>
                        </div>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="uUid" onblur="creatorIptBlur(this)" onfocus="creatorIptFocus(this)"
                                   data-u-uid="${orgInfo.uUid}"
                                   data-org-mid="${orgInfo.uMobile == null || orgInfo.uMobile.equals("")?'':orgInfo.orgMid}"
                                   value="${orgInfo.uMobile}" class="lab_input_base lab_input_middle"
                                   type="text" placeholder="请输入创建者电话"
                            ${orgInfo.uMobile==null?'':'readonly="readonly"'
                                    }>
                        </div>
                    </div>
            ...
            <%--START操作按鈕--%>
            <div class=" share_btn">
                <button class="put_form layui-btn layui-btn-normal" type="button" id="putForm"
                        onclick="putOrgForm()">
                    确认修改
                </button>
            </div>
...
<script>
    ...
    // 修改机构时独有字段
    console.log('${orgInfo.orgPositionList.size() > 0}')
    JcropResult = {
        x: '${orgInfo.orgPositionList.size() > 0 && orgInfo.orgPositionList.get(0) != null && orgInfo.orgPositionList.get(0) != ''?orgInfo.orgPositionList.get(0):''}',
        y: '${orgInfo.orgPositionList.size() > 0 && orgInfo.orgPositionList.get(1) != null && orgInfo.orgPositionList.get(1) != ''?orgInfo.orgPositionList.get(1):''}',
        w: '${orgInfo.orgPositionList.size() > 0 && orgInfo.orgPositionList.get(2) != null && orgInfo.orgPositionList.get(2) != ''?orgInfo.orgPositionList.get(2):''}',
        h: '${orgInfo.orgPositionList.size() > 0 && orgInfo.orgPositionList.get(3) != null && orgInfo.orgPositionList.get(3) != ''?orgInfo.orgPositionList.get(3):''}',
...
//            marker.addEventListener("click", function () { this.openInfoWindow(infoWindow); });
    ...
    function putOrgForm() {
        ...
        var orgLogo = "";// 机构logo路径
        var orgLogoPosition = "";// 机构Logo裁剪值

        if (JcropResult.x === "" || JcropResult === null) {
        ...
        var orgAddrId = $("#addCon").data('orgAddrId');
        ...
        itemList.each(function () {
            ...
            var iptQftId = $(this).find("input").data("qftId");
            ...
            // 如果机构Id存在，就添加机构ID
            if (iptQftId && iptQftId !== "undefined") {
                orgCertificateList[orgCertificateList.length - 1].orgCertificateId = iptQftId;
            }
        ...
        if ($("#uUid").data("orgMid")) {
            formData.orgMid = $("#uUid").data("orgMid");
        }
...
//        if (formData.orgCode.length != 0) {
//           if (!/^[0-9A-Za-z]{18}$/.test(formData.orgCode)) {
//               alert("组织机构代码格式错误");
//               return false;
//            }
//        }
...
//            if (!/^0\d{2,3}-\d{7,8}(-\d{1,6})?$/.test(orgPhone)) {
//                alert("机构电话格式错误");
//                return false;
//            }
//        }
