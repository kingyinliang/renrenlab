        ...
        <div class="main" style="overflow-y: auto">
            ...
            <div class="hdNav">
                <span class="layui-breadcrumb">
                    <a href="${rlab}/bg/manager/list">角色权限管理</a>
                    <a href="${rlab}/bg/manager/list">管理员列表</a>
                    <a href="#">详情</a>
                </span>
            </div>
                ...
                <form class="layui-form" action="">
                    ...
                    <div class="admin_info clearfix">
                        <label class="form_coomon" style="width: 325px;">
                            <s>邮&nbsp;&nbsp;&nbsp;&nbsp;箱：</s>
                            <div class="ipt_min">
                                <input id="email" type="text" class="texts" placeholder="请输入邮箱" value="${managerInfo.uEmail}"
                                       disabled>
                            </div>
                        </label>
                        ...
                        <label class="form_coomon" style="width: 325px;">
                            <s>个人姓名：</s>
                            <div class="ipt_min">
                                <input id="name" type="text" placeholder="输入员工姓名" class="texts" value="${managerInfo.uName}" disabled>
                            </div>
                        </label>
                        <label class="form_coomon" style="width: 325px;margin-left: 68px;">
                            <s>联系电话：</s>
                            <div class="ipt_min">
                                <input id="phone" type="text" placeholder="输入联系电话" class="texts" value="${managerInfo.uMobile}" disabled>
                            </div>
                        </label>
                        <label class="form_coomon" style="width: 325px;">
                            <s>工&nbsp;&nbsp;&nbsp;号：</s>
                            <div class="ipt_min">
                                <input id="number" type="text" placeholder="输入输入员工编号" class="texts" value="${managerInfo.jobNum}" disabled>
                            </div>
                        </label>
                        <label class="form_coomon" style="width: 325px;margin-left: 68px;">
                            <s>部&nbsp;&nbsp;&nbsp;门：</s>
                            <div class="ipt_min">
                                <select lay-filter="changeDepartment">
                                    ...
                                    <option value="总裁办" ${managerInfo.department=='总裁办'?'selected':''}>总裁办</option>
                                    <option value="运营部" ${managerInfo.department=='运营部'?'selected':''}>运营部</option>
                                    <option value="产品部" ${managerInfo.department=='产品部'?'selected':''}>产品部</option>
                                    <option value="市场部" ${managerInfo.department=='市场部'?'selected':''}>市场部</option>
                                    <option value="技术部" ${managerInfo.department=='技术部'?'selected':''}>技术部</option>
                                    <option value="客服部" ${managerInfo.department=='客服部'?'selected':''}>客服部</option>
                                </select>
                            </div>
                        </label>
                    </div>
...
<script type="text/javascript">
    ...
    var deparment = '${managerInfo.department}';
    var admin = ${managerInfo.roleIds};

    for (var i=0;i<admin.length;i++){
        $("input[name=changeAdmin]").each(function () {
            if(admin[i]==$(this).val()){
    ...
    function cfmAlter() {
        ...
        var data = {
            'uUid':${managerInfo.uUid},
            'department': deparment,
            'roleIds': JSON.stringify(admin)
        };

        $.ajax({
            url: '${rlab}/bg/manager/modifyManager',
            type: 'POST',
