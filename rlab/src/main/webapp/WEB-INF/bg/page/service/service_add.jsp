        ...
        <div class="main" style="overflow-y: auto">
            ...
            <div class="orgCorporation">
                ...
                <div class="lab_p clearfix">
                    ...
                    <input type="text" placeholder="请输入服务名称" id="serviceName" maxlength="100">
                </div>
                ...
                <div class="lab_p clearfix svc_price">
                    ...
                    <div class="rt">
                        <div class="price_radio">
                            <p>
                                <input data-origin="all" id="face" type="radio" name="price"
                                       onclick="switchRadio(this)">
                                <label for="face">面议</label>
                            </p>
                            <p>
                                <input data-origin="fixed" id="specific" type="radio" checked name="price"
                                       onclick="switchRadio(this)">
                                <label for="specific">具体价格</label>
                            </p>
                            <p>
                                <input data-origin="range" id="range" type="radio" name="price"
                                       onclick="switchRadio(this)">
                                <label for="range">价格范围</label>
                            </p>
                        </div>
                        <div class="price_main">
                            <div id="fixedPrice" class="specific_main" style="display: block;">
                                <input id="fixedPriceP" type="text" placeholder="具体价格">
                                &nbsp;元 /&nbsp;
                                <input id="fixedUnit" maxlength="10" type="text" placeholder="单位">
                            </div>
                            <div id="rangPrice" class="range_main" style="display: none;">
                                <input id="rangeSubPrice" type="text" placeholder="最低价">&nbsp;元 ~&nbsp;
                                <input id="rangeSupPrice" type="text" placeholder="最高价">&nbsp;元 /&nbsp;
            ...
            <div class="orgMessage">
                <form class="layui-form" action="">
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="serviceMethos" type="text" placeholder="依据方法" maxlength="200">
                        </div>
                    </div>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="serviceCycle" type="text" placeholder="服务周期" maxlength="200">
                        </div>
                    </div>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input id="otherInfo" type="text" placeholder="其他备注" maxlength="1000">
                        </div>
                    </div>
                    <%--联系方式--%>
                    <div class="lab_p clearfix">
                                ...
                                <div class="rowphone clearfix">
                                    ...
                                    <div class="phone" style="margin-left: 90px">
                                        <div>
                                            ...
                                            <%--<a href="javascript:void (0)" onclick="addPhone(this)"--%>
                                            <%--style="margin-bottom: 10px;color:#6693c8;font-size:14px;line-height: 30px;">添加手机号</a>--%>
                                        </div>
                                    </div>
                                    <%--<button class="delete_btn" onclick="removePhoneRow(this)"><i--%>
                                    <%--class="layui-icon"></i> 删除--%>
                    ...
                    <div class="lab_p clearfix">
                        ...
                        <div class="rt">
                            <input maxlength="50" type="text" onblur="updateJingWeiDu()" placeholder="请输入详细地址"
                                   id="addressDetail_1">
                            </p>
                        </div>
                    </div>
            ...
            <div class="share_btn" style="text-align: center;margin-top: 50px">
                <button class=" layui-btn layui-btn-normal" type="button" id="putForm" onclick="putOrgForm()">新增服务
                </button>
            </div>
        </div>
    </div>
                    ...
                    qftLists.each(function () {
                        if ($.trim($(this).text()) == data.payload[i].aptitudeName) {
                            fileList.append(
                                '<div style="min-width: 24%; line-height: 27px;display: inline-block; margin-top: 5px;padding: 0 5px;">\
                                    <label>\
                                     <input data-qft-id="' + $(this).data('qftId') + '" data-src="' + $(this).prev("img").attr("src") + '" checked data-qft-name="' + data.payload[i].name + '"  type="checkbox" name="qualifications" value="' + data.payload[i].aptitudeName + '" style="display: inline-block;height: 14px;width: 14px;" >\
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === 0) {
                    ...
                    location.href = BASE_URL + "/bg/service/detail?serviceId=" + data.payload.result;
