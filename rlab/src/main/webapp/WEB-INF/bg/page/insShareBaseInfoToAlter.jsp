...
<div class="wrapper">
    ...
    <div class="comn">
        ...
        <div class="main" style="overflow-y: auto">
            ...
            <div class="infModify">
                <p>仪器名称<em>*</em>：<input type="text" class="insName" placeholder="" value="${detail.insName}" id="mname" maxlength="100"></p>
                <p>仪器型号<em>*</em>：<input type="text" class="insType" placeholder="" value="${detail.insMode}" id="mtype" maxlength="100"></p>
                ...
                <p>仪器品牌<em>*</em>：<input type="text" class="insBrand" placeholder="" value="${detail.insBrand}" id="insBrand" maxlength="100"></p>
                <p>仪器产地<em>*</em>：<input type="text" class="insAddress" placeholder="" value="${detail.insOrigin}" id="insOrigin" maxlength="100">
                </p>
                <div class="clearfix infP">
                    ...
                    <div class="listNature" id="instype2">
                        <div class="input layui-form-select"><span data-cate-id="${detail.insCategoryList[1].insCategory}">${detail.insCategoryList[1].categoryName}</span><i class="layui-edge"></i></div>
                        <dl class="dldd">
                    ...
                    <div class="listNature" id="instype3">
                        <div class="input layui-form-select"><span data-cate-id="${detail.insCategoryList[2].insCategory}">${detail.insCategoryList[2].categoryName}</span><i class="layui-edge"></i></div>
                        <dl class="dldd">
                        ...
                        <table class="layui-table">
                            ...
                            <%--<c:forEach items="${detail.insCoreParam}" var="core">--%>
                                <%--<tr>--%>
                                    ...
                                    <%--<td><input type="text" placeholder="" value="${core.content}" maxlength="100"></td>--%>
                                <%--</tr>--%>
                            <%--</c:forEach>--%>
                            <c:forEach items="${detail.insCoreParam}" var="core">
                                <tr>
                ...
                <div class="save">
                    <button class="layui-btn" onclick="save()" data-ins-id="${detail.mapId}" id="save">保存仪器</button>
                </div>
            </div>
        </div>
    </div>
