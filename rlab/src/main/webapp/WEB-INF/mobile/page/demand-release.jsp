    ...
    <div class="content">
        <div style="padding: 0.32rem">
            ...
            <div class="substance">
                ...
                <textarea id="text" maxlength="140" placeholder="为了保证您获得质量更佳的服务，请具体描述该实验项目的可公开信息，包括但不限于研究目的/背景介绍、实验样品（名称、数量、状态、处理方式等）、实验方法（标准、技术规范等）、实验仪器设备（名称、品牌、型号等）以及服务方资质要求等。"></textarea>
            </div>
        </div>
        <div class="both_btn">
            发 布
