...
<div id="main" class="main" style="background: white;">
    <header>
        ...
        <p class="headtitle">${tag}</p>
    </header>
    <div class="instab" style="top: 1.175rem;display:${tag=='人人实验室' ?'none':'block'}; ">
    ...
    <div id="listmain" class="mui-content mui-scroll-wrapper" style="margin-top: ${tag!='人人实验室'?'2.245rem':'1.175rem'};">
            ...
            <ul class="mui-table-view mui-table-view-chevron"  data-page-no="2" data-type-str="" data-city-str="">
                <c:if test="${tag=='人人实验室'}">
                    <li class="clearfix">
                        <img src="" alt="">
                        <div class="itemlitxt">
                            <p class="itemtit">理化分析实验室</p>
                            <div><span style="margin-right: 0.347rem">北京市</span><span>昌平区</span></div>
                        </div>
                    </li>
                    <li class="clearfix">
                        <img src="" alt="">
...
<script type="text/javascript">
    ...
    function getlist(str,num,city,ul) {
        ...
        if(${tag=="人人实验室"}){
            ...
            $.ajax({
                url: BASE_URL + '/front/search/cro?tag=${tag}&keyword=${keyword}&pageNo=' + num + '&category2=' + str + '&city=' +city,
                type: 'GET',
                dataType: "json",
