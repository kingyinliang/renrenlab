    ...
    <div class="main clearfix" style="margin-top: 1.175rem;">
        ...
        <div class="goods_info">
            ...
            <div class="goods_title">
                <c:out value="${serviceInfo.serviceName}" escapeXml="true"/>
            </div>
            <%-- 服务参数 --%>
            <div class="goods_param">
                <%--服务编号--%>
                <c:if test="${serviceInfo.serviceId != null && !''.equals(serviceInfo.serviceId)}">
                    <p class="clearfix">
                        <i class="lab-dot-1"></i>
                        <s>服务编号：</s>
                        <span><c:out value="${serviceInfo.serviceId}" escapeXml="true"/></span>
                    </p>
                </c:if>
                <%--所在地区--%>
                <p class="clearfix">
                ...
                <p class="clearfix">
                    ...
                    <s>服务特点：</s>
                    <span>
                        <c:if test="${serviceInfo.serviceFeature == null || ''.equals(serviceInfo.serviceFeature)  || serviceInfo.serviceFeature.size() <= 0}">
                            数据更新中
                        </c:if>
                ...
                <p class="clearfix">
                    ...
                    <s>服务资质：</s>
                    <span>
                      <c:if test="${serviceInfo.serviceCredit == null || ''.equals(serviceInfo.serviceCredit)  || serviceInfo.serviceCredit.size() <= 0}">
                          数据更新中
                      </c:if>
                         ...
                         <c:choose>
                             <c:when test="${serviceInfo.servicePrice.flag == 1}">
                                 <c:if test='${"无".equals(serviceInfo.servicePrice.unit)}'>
                                     ￥${serviceInfo.servicePrice.accPrice}
                                 </c:if>
                                 <c:if test='${!"无".equals(serviceInfo.servicePrice.unit)}'>
                                     ￥${serviceInfo.servicePrice.accPrice}/${serviceInfo.servicePrice.unit}
                                 </c:if>
                             </c:when>
                             <c:when test="${serviceInfo.servicePrice.flag  == 2}">
                                 <c:if test='${serviceInfo.servicePrice.scopeHighPrice.equals("0")}'>
                                     <c:if test='${"无".equals(serviceInfo.servicePrice.unit)}'>
                                         ￥${serviceInfo.servicePrice.scopeLowPrice}起
                                     </c:if>
                                     <c:if test='${!"无".equals(serviceInfo.servicePrice.unit)}'>
                                         ￥${serviceInfo.servicePrice.scopeLowPrice}/${serviceInfo.servicePrice.unit}起
                                     </c:if>
                                 </c:if>
                                 <c:if test='${!serviceInfo.servicePrice.scopeHighPrice.equals("0")}'>
                                     <c:if test='${"无".equals(serviceInfo.servicePrice.unit)}'>
                                         ￥${serviceInfo.servicePrice.scopeLowPrice} ~ ${serviceInfo.servicePrice.scopeHighPrice}
                                     </c:if>
                                     <c:if test='${!"无".equals(serviceInfo.servicePrice.unit)}'>
                                         ￥${serviceInfo.servicePrice.scopeLowPrice} ~ ${serviceInfo.servicePrice.scopeHighPrice}/${serviceInfo.servicePrice.unit}
                                     </c:if>
                                 </c:if>
                             </c:when>
            ...
            <div class="goods_remark">
                <span>
                    <c:out value="${serviceInfo.servicePrice.remark.length() > 15 ? serviceInfo.servicePrice.remark.substring(0,15).concat('...') :serviceInfo.servicePrice.remark}" escapeXml="true"/>
                </span>
            </div>
        </div>
                    ...
                    <%--<div class="item last_item ins_address">--%>
                        ...
                        <%--<div class="add">--%>
                            <%--<s class="lab-zuobiao"></s>--%>
                             <%--${serviceInfo.serviceProvince}${serviceInfo.serviceCity}${serviceInfo.serviceDistrict}${serviceInfo.serviceAddress}--%>
                        <%--</div>--%>
                        <%--<div class="phone">--%>
        ...
        <div class="goods_state">
            ...
            <div class="st_list">
                ...
                <div class="item last_item">
                    <h4><i></i>使用设备</h4>
                    <p>
                        <c:if test="${serviceInfo.serviceMachine == null}">
                            数据更新中
                        </c:if>
...
//    }
    ...
    function push() {
        window.location.href = BASE_URL + "/org/" + ${orgInfo.orgOid};
    }
