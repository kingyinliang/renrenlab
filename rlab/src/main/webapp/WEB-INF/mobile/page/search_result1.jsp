...
<div id="main" class="main" style="background: white;">
    ...
    <div class="fixedTab">
        ...
        <a href="${rlab}/front/search/p1?searchKey=${keyword}" class="seledTab">科创头条</a>
...
<script type="text/javascript">
    ...
    function getlist(ul) {
        ...
        var li;
        $.ajax({
            url: BASE_URL +  '/front/search/sciences?keyword=${keyword}&classifyName=&pageNo=' + num,
            type: 'GET',
            dataType: "json",
    ...
    mui("#listmain").on("tap","li",function(){
        window.location.href = BASE_URL + '/news/get_article_detail?id=' + $(this).data("insId");
    });
</script>
</html>