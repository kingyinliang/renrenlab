    ...
    <div class="comn">
        ...
        <div class="main" style="overflow-y: auto">
            ...
            <div class="panel_section">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <select id="shareInsStatus" lay-filter="shareInsStatus" name="modules"
                                            lay-verify="required">
                                        <option value="99">请选择需求状态</option>
                ...
                <div class="audit">
                    <button class="lab_btn_base lab_btn_base_2 bd_light_grn cl_light_grn" type="button"
                            onclick="acceptDemand()">审核通过
                    </button>
                    <button class="lab_btn_base lab_btn_base_2 bd_leaf_yl cl_leaf_yl" type="button"
                            onclick="rejectDemand()">审核不通过
                    </button>
            ...
            <div class="lab_list_type1">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="${rlab}/bg/page/demand_detail.jsp">查看详情</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0)">延长有效期</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
