...
import com.renrenlab.rlab.common.shiro.MyRealm;
import com.renrenlab.rlab.common.shiro.session.CustomSessionManager;
...
public class TokenManager {
     ...
     * @return
     */
    public static UserBaseInfo getToken() {
        UserBaseInfo token = (UserBaseInfo) SecurityUtils.getSubject().getPrincipal();
        return token;
    }
