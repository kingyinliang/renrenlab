...
public class SuperSearchImpl implements ISuperSearchService {
     ...
     */
    @Override
    public JSONArray relatedInterest(String keyword) {
        JSONArray interestArr = null;
        if (StringUtils.isNotEmpty(keyword)) {
            interestArr = new JSONArray();
            List<Map<String, Object>> interets = (List<Map<String, Object>>) searchInterestWords(keyword);
