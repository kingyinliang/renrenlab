...
public class InstrumentController {
    ...
    public String toBgInstrumentSearch(Model model,
        ...
        for (InstrumentInfo info : infos.getList()) {
            Price price = InsUtil.handlePrice(info.getInsOrgPriceList().toString());
    ...
    public String toBgInstrumentDetail(Model model, @RequestParam Long insIid, @RequestParam Long mapId) {
        ...
        if (instrumentInfo.getInsOrgPriceList() != null) {
            InsUtil.handlePrice(instrumentInfo.getInsOrgPriceList().toString());
            model.addAttribute("price", InsUtil.handlePrice(instrumentInfo.getInsOrgPriceList().toString()));
        }
        //图片处理
        if (instrumentInfo.getInsPic() != null) {
            model.addAttribute("insPicList", InsUtil.handlePic(instrumentInfo.getInsPic().toString()));
        }
