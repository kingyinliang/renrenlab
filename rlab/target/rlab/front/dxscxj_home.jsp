                ...
                <div class="lengthways">
                    <div class="line" style="height: 360px;">
                        ...
                        <div class="lft" style="top:36px;">
                            ...
                            <div class="section">
                                <div class="package">
                                    <img src="${rlab}/front/imgs/cxj/cx_icon_6@1.0.jpg" alt="">
                                    <p>下载填写</p>
                                    <c:choose>
                                        <c:when test="${sessionScope.uid != null}">
                                            <p><a download href="
http://renrenlab.oss-cn-shanghai.aliyuncs.com/other/2017/08/02/%E4%BA%BA%E4%BA%BA%E5%88%9B%E6%96%B0%E5%88%B8%E4%BC%81%E4%B8%9A%E5%9F%BA%E6%9C%AC%E4%BF%A1%E6%81%AF%E8%A1%A8%EF%BC%88201708%E7%89%88%EF%BC%89.docx">企业基本信息表</a>
                                            </p>

                                        </c:when>
                                        <c:otherwise>
                                            <p><a onclick="isLogin()" href="javascript:void(0)">企业基本信息表</a></p>
                                        </c:otherwise>
                                    </c:choose>
                        ...
                        <div class="rt" style="top:150px;">
                            ...
                            <div class="section">
                                ...
                                <p class="describe">
                                    电子版发送邮件至service@renrenlab.com<br>
                                    <span>（邮件主题：人人创新券用户资格认证+企业名称+联系人+手机号）</span><br>
                                    收到审核回复邮件后，将纸版邮寄至人人实验办公地址
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="line" style="height: 360px;">
                            ...
                            <div class="section">
                                <div class="package">
                                    ...
                                    <c:choose>
                                        <c:when test="${sessionScope.uid != null}">
                                            <p><a download
                                                  href="http://renrenlab.oss-cn-shanghai.aliyuncs.com/other/2017/08/02/%E4%BA%BA%E4%BA%BA%E5%88%9B%E6%96%B0%E5%88%B8%E9%A1%B9%E7%9B%AE%E7%94%B3%E8%AF%B7%E8%A1%A8%EF%BC%88201708%E7%89%88%EF%BC%89.docx">创新券项目申请表</a>
                                            </p>
                                        </c:when>
                                        <c:otherwise>
                                            <p><a href="javascript:void(0)" onclick="isLogin()">创新券项目申请表</a></p>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                <p class="describe">
                        ...
                        <div class="rt" style="top:150px;">
                            ...
                            <div class="section">
                                ...
                                <p class="describe">
                                    电子版发送邮件至service@renrenlab.com<br>
                                    <span>（邮件主题：人人创新券项目申请+企业名称+联系人+手机号）</span><br>
                                    收到审核回复邮件后，将纸版邮寄至人人实验办公地址
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="line" style="height: 460px;">
                        ...
                        <div class="lft" style="top:260px;">
                            ...
                            <div class="section">
                                ...
                                <p class="describe">
                                    电子版发送邮件至service@renrenlab.com <br>
                                    <span>（邮件主题：人人创新券项目材料备案+企业名称+联系人+手机号）</span><br>
                                    收到审核回复邮件后，将纸版邮寄至人人实验办公地址
                                </p>
                            </div>
                        </div>
    ...
    <!--底部底边栏-->
    <jsp:include page="${rlab}/template/footer.jsp"></jsp:include>
    <!--绑定手机号弹窗源码-->
</div>
<!--my common js-->
<%--<div class="md_ctnt" >--%>
